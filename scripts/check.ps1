...
Assert-Contains -RelativePath 'docs/ui-visual-spec.md' -Pattern '^### 7\.8 情报\s*$' -Description '情报页面规范'
...
Assert-Contains -RelativePath 'docs/tasks.md' -Pattern '^### TASK-019 第一版情报主链最终验收\s*$' -Description '最终验收任务'
...
Assert-Contains -RelativePath 'docs/tasks.md' -Pattern '^### BIZ-008 真实情报至资料、选题与内容完整验收\s*$' -Description '内容情报工作台最终验收'
Assert-Contains -RelativePath 'docs/spec.md' -Pattern '^## 15\. 内容情报工作台扩展\s*$' -Description '内容情报工作台技术契约'
